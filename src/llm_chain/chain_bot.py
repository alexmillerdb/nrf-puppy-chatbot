...
chat_preprocess.extract_history(chat_hist)

# COMMAND ----------

chain_factory = ChainFactory(chat_preprocess=chat_preprocess, chat_model=model.chat_model)
chain_with_history = chain_factory.create_chain_with_history(prompt_template_str=config.prompt_with_history_str, input_vars=["chat_history", "question"])
chain_with_history.invoke(chat_hist)

# COMMAND ----------

# model.chain_with_history(chat_hist)
chain_with_history = model.create_chain_with_history(config.prompt_with_history_str, input_vars=["chat_history", "question"])
chain_with_history.invoke(chat_hist)
