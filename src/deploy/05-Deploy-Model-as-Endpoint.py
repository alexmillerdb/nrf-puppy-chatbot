...
# MAGIC %md ### Add Model name and serving endpoint name to config
...
w = WorkspaceClient()
serving_client = EndpointApiClient(base_url=base_url, token=token)
