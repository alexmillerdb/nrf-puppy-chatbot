...
# MAGIC %pip install databricks-vectorsearch==0.22 mlflow==2.9.0
# MAGIC dbutils.library.restartPython()

# COMMAND ----------

from pyspark.sql import functions as F
from functions.data_prep import create_cdc_table
from functions.vector_search_setup import wait_for_vs_endpoint_to_be_ready, index_exists, wait_for_index_to_be_ready
...
VECTOR_SEARCH_ENDPOINT_NAME = "petm_genai_chatbot_2"
# catalog = "main"
...
vs_index_fullname = f"{catalog}.{db}.{source_table}_index_2"
