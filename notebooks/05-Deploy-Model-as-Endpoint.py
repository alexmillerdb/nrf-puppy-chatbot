...
# serving_endpoint_name = "nrf_petm_chatbot_endpoint"
...
# serving_client = EndpointApiClient(base_url=url, token=token)
...
environment_vars={"DATABRICKS_TOKEN": "{{secrets/nrf-petm-chatbot/rag-pat-token}}"}
...
# %sql
# drop table if exists main.databricks_petm_chatbot.nrf_petm_chatbot_endpoint_payload;
...
list(set(response['predictions'][0]['sources']))
